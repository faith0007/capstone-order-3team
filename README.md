...
2.고객이 주문을 취소할 수 있다 (Customer can cancel order)
3.고객은 언제든지 주문한 내역과 배송 상태를 조회한다. (CQRS - View)

<상품>
4. 주문정보가 들어오면 상품이 준비된다
5. 주문이 취소되면 상품준비를 취소한다
...
<알림>
10.주문/배송상태가 바뀌면 고객에게 알림을 보낸다. 



비기능적 요구사항

1. 결제가 되지 않은 주문건은 거래가 성립되지 않아야 한다
2. 고객이 자주 상점관리에서 확인할 수 있는 배달상태를 주문시스템(프론트엔드)에서 확인할 수 있어야 한다  CQRS
